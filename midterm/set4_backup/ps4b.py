...
def playGame(wordList):
    ...
    #### Este foi a minha primeira hipótese ####
    ...
    while True:
        ...
        if valor == 'e':
            ...
            valor2 = input('Enter u to have yourself play, c to have the computer play:')
            if valor2 == 'u':
                n = HAND_SIZE
                palavra = dealHand(n)
                ...
                n = HAND_SIZE
                palavra = dealHand(n)
               #compChooseWord(palavra, wordList, n)
                compPlayHand(palavra, wordList, n)
            else:
